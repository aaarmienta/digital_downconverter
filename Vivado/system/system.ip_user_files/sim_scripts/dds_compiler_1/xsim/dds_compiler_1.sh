...
#
# Generated by Vivado on Tue Oct 25 23:07:07 -0700 2022
...
# Script info
echo -e "dds_compiler_1.sh - Script generated by export_simulation (Vivado v2022.1 (64-bit)-id)\n"
...
simulate()
{
  xsim dds_compiler_1 -key {Behavioral:sim_1:Functional:dds_compiler_1} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
