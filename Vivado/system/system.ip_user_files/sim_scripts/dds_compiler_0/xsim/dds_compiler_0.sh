...
#
# Generated by Vivado on Tue Oct 25 00:56:48 -0700 2022
...
simulate()
{
  xsim dds_compiler_0 -key {Behavioral:sim_1:Functional:dds_compiler_0} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
