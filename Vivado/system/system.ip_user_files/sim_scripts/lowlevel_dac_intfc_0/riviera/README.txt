...
#
# Generated by export_simulation on Tue Oct 25 01:56:33 -0700 2022
#
################################################################################
...
'-reset_run' switch to the './lowlevel_dac_intfc_0.sh' script.

./lowlevel_dac_intfc_0.sh -reset_run
...
./lowlevel_dac_intfc_0.sh -noclean_files

For more information on the script, please type './lowlevel_dac_intfc_0.sh -help'.
