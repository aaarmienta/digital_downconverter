...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../system.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../system.gen/sources_1/bd/design_1/ipshared/5765/hdl" \
       +incdir+"../../../../system.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../system.gen/sources_1/bd/design_1/ipshared/5765/hdl" \
