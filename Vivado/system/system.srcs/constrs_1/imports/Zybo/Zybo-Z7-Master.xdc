...
##Switches
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { sel }]; #IO_L19N_T3_VREF_35 Sch=sw[0]
...
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { muten }]; #IO_L23N_T3_34 Sch=ac_muten
