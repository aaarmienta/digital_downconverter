...
HD_PWD='C:/Users/alber/OneDrive/Documents/Xilinx/DDC/Vivado/system/system.runs/lowlevel_dac_intfc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lowlevel_dac_intfc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lowlevel_dac_intfc_0.tcl
